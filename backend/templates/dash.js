    ...
    const make_template = function(files, name){
        ...
        if(files.length > 0){
            for(let i=0; i < files.length; i++){
                ...
                <h3 style="width: 200px;">${files[i].uploded_file_name}</h3>
                <h3 class="des_content">${files[i].uploaded_file_description}</h3>
                <h3 style="width: 240px; text-align: center;">${local_d}</h3>
                <h3 style="width: 240px; text-align: center;">${files[i].uploaded_file_category}</h3>
